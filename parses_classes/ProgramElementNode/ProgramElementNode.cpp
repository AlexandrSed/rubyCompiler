...
class ProgramElementNode {
    public:
        static ProgramElementNode* ProgramElementNode::createClassProgramElementNode(ClassStmtNode* classNode) {
            ProgramElementNode* result = new ProgramElementNode;
            result->classNode = classNode;
            result->idNode = ++ProgramElementNode::maxId;
            return result;
        }
        static ProgramElementNode* ProgramElementNode::createMethodProgramElementNode(MethodStmtNode* methodNode) {
            ProgramElementNode* result = new ProgramElementNode;
            result->methodNode = methodNode;
            result->idNode = ++ProgramElementNode::maxId;
            return result;
        }
        static ProgramElementNode* ProgramElementNode::createStmtProgramElementNode(StmtNode* stmtNode) {
            ProgramElementNode* result = new ProgramElementNode;
